(function($){
	...
	function sc_stopScroll(a,b){
		...
		for(var c=0,d=a.anims.length;d>c;c++){
			...
			e[0].stop(!0),
			b&&(e[0].css(e[1]),
				is_function(e[2])&&e[2]())}is_object(a.post)&&sc_stopScroll(a.post,b)
		}

	function sc_afterScroll(a,b,c){
		switch(b&&b.remove(),
			c.fx){ case"fade":case"crossfade":case"cover-fade":case"uncover-fade":a.css("opacity",1),
		a.css("filter","")}
		    ...
		    var e="hide"
	         ...
	         function go_getItemsObject(a,b){
	         	return b=go_getObject(a,b),
	         				is_number(b)?b={visible:b}:
	         				"variable"==b?b={visible:b,width:b,height:b}:
	         				is_object(b)||(b={}),b
	         			}
	         			function go_getScrollObject(a,b){
	         				return b=go_getObject(a,b),
	         				is_number(b)?b=50>=b?{items:b}:
	         				{duration:b}:
	         				is_string(b)?b={easing:b}:
	         				is_object(b)||(b={}),b
	         			}
	         		...
	         		function go_getAutoObject(a,b){
	         			...
	         			is_jquery(b)?b={button:b}:
	         			is_boolean(b)?b={play:b}:
	         		...
	         		function go_complementAutoObject(a,b){
	         			...
	         			is_number(b.timeoutDuration)||(b.timeoutDuration=10>b.duration?2500:
	         				5*b.duration),
	         		...
	         		function go_getPrevNextObject(a,b){return b=go_getNaviObject(a,b),
	         			is_jquery(b)?b={button:
	         				b
	         			}:
	         			is_number(b)&&(b={key:b}),
	         			b
	         		...
	         		function go_complementPrevNextObject(a,b){
	         			...
	         			b}function go_getPaginationObject(a,b){
	         				return b=go_getNaviObject(a,b),
	         				is_jquery(b)?b={container:b
	         				}:
	         			...
	         			function go_getSwipeObject(a,b){
	         				...
	         				is_true(b)?b={onTouch:b
	         				}:
	         				is_number(b)&&(b={items:b}),
	         				b
	         			}
	         			...
	         			function go_getMousewheelObject(a,b){
	         				return is_function(b)&&(b=b.call(a)),
	         				is_true(b)?b={}:is_number(b)?b={items:b
	         				}:
	         				is_undefined(b)&&(b=!1),
	         				b
	         			}
	         			...
	         			function gn_getItemIndex(a,b,c,d,e){
	         				if(is_string(a)&&(a=$(a,e)),
	         					...
	         					is_number(a)||(a=0),
	         					is_number(b)||(b=0),
	         					c&&(a+=d.first),a+=b,d.total>0){
	         					for(;a>=d.total;)a-=d.total;for(;0>a;)a+=d.total
	         				}
	         			return a
	         		}
	         		function gn_getVisibleItemsPrev(a,b,c){
	         			for(var d=0,e=0,f=c;f>=0;f--){var g=a.eq(f);
	         				if(d+=g.is(":visible")?g[b.d.outerWidth](!0):0,d>b.maxDimension)return e;
	         				0==f&&(f=a.length),e++}}function gn_getVisibleItemsPrevFilter(a,b,c){
	         				...
	         				function gn_getItemsPrevFilter(a,b,c,d){
	         					for(var e=0,f=0,g=d,h=a.length;g>=0;g--){
	         						if(f++,f==h)return f;var i=a.eq(g);
	         						if(i.is(b)&&(e++,e==c))return f;0==g&&(g=h)
	         					}
	         				}
	         				...
	         				function gn_getItemsNextFilter(a,b,c,d){
	         					for(var f=0,g=0,h=d,i=a.length-1;
	         						i>=h;
	         						h++){
	         						if(g++,g>=i)return g;
	         					var j=a.eq(h);
	         			...
	         			function sz_resetMargin(a,b,c){
	         				if(b.usePadding){
	         					...
	         					a.each(function(){
	         						var a=$(this);
	         						a.css(b.d.marginRight,d?a.data("_cfs_tempCssMargin"):
	         							c+a.data("_cfs_origCssMargin"))
	         					}
	         					)
	         				}
	         			}
	         			...
	         			function sz_setResponsiveSizes(a,b){
	         				...
	         				e=a[a.d.height],f=is_percentage(e);
	         				b.each(function(){
	         					var b=$(this),
	         			...
	         			function ms_getLargestSize(a,b,c,d){
	         				...
	         				is_number(b[b.d[c]])&&d?b[b.d[c]]:
	         				is_number(b.items[b.d[c]])?b.items[b.d[c]]:
	         				(c=c.toLowerCase().indexOf("width")>-1?"outerWidth":
	         					"outerHeight",ms_getTrueLargestSize(a,b,c))
	         			}
	         			function ms_getTrueLargestSize(a,b,c){
	         				for(var d=0,e=0,f=a.length;
	         					f>e;e++){var g=a.eq(e),
	         		...
	         		function ms_getTotalSize(a,b,c,d){
	         			if(is_boolean(d)||(d=!1),
	         				is_number(b[b.d[c]])&&d)return b[b.d[c]];
	         				if(is_number(b.items[b.d[c]]))return b.items[b.d[c]]*a.length;
	         			for(var e=c.toLowerCase().indexOf("width")>-1?"outerWidth":"outerHeight",
	         				f=0,g=0,h=a.length;h>g;
	         				g++){var i=a.eq(g);
	         				f+=i.is(":visible")?i[b.d[e]](!0):
	         			0
	         		}
	         		return f}function ms_getParentSize(a,b,c){
	         			var d=a.is(":visible");
	         			d&&a.hide();
	         			var e=a.parent()[b.d[c]]();
	         			return d&&a.show(),e}function ms_getMaxDimension(a,b){
	         			...
	         			function ms_getPercentage(a,b){
	         				...
	         				function cf_c(a,b){
	         					return is_string(b.classnames[a])?b.classnames[a]:
	         					a
	         				}
	         				...
	         				function cf_sortParams(a,b){
	         					for(var c=[],
	         						...
	         						g>f;f++)if(b[f].indexOf(typeof a[d])>-1&&is_undefined(c[f])){
	         							c[f]=a[d];
	         						break}return c
	         					}
	         					function cf_getPadding(a){
	         						...
	         						if(is_string(a)&&(a=a.split("px").join("").split("em").join("").split(" ")),
	         							...
	         							for(var b=0;
	         								...
	         								switch(a.length){case 0:return[0,0,0,0];
	         									case 1:return[a[0],
	         									a[0],
	         									a[0],
	         									a[0]];
	         							...
	         							function cf_getAlignPadding(a,b){
	         								...
	         								switch(b.align){
	         									case"left":return[0,c];
	         									case"right":return[c,0];
	         									case"center":default:return[Math.ceil(c/2),
	         									Math.floor(c/2)]
	         								}
	         							}
	         							function cf_getDimensions(a){
	         								for(var b=[["width","innerWidth","outerWidth","height","innerHeight","outerHeight","left","top","marginRight",0,1,2,3],
	         							...
	         							function cf_getAdjust(a,b,c,d){
	         								...
	         								if(is_function(c))e=c.call(d,e);
	         									...
	         									j=f[1];
	         									switch(i){
	         										case"even":e=1==a%2?a-1:a;
	         										break;
	         										case"odd":e=0==a%2?a-1:a;
	         										break;
	         										default:e=a
	         									}
	         									j=parseInt(j,10),
	         									is_number(j)&&(h&&(j=-j),
	         										e+=j)}return(!is_number(e)||1>e)&&(e=1),
	         									e
	         								}
